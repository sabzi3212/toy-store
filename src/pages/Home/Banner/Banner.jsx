    ...
    return (
        <div className="carousel w-full h-[600px] mt-6">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute flex justify-between transform -translate--1/2 left-10 right-3 top-1/2">
                    <div>
                        <h2 className='text-7xl text-center'>Find best toys for your kid</h2>
                    </div>
                </div>
